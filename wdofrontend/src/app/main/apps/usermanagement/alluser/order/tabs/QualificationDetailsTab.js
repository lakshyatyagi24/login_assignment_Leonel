...
const QualificationDetailsTab = React.forwardRef((props, ref) => {

  const defaultValues = {
    board_name1: props.qualification_details.tenth.board_name,
    year1: props.qualification_details.tenth.year,
    percentage1: props.qualification_details.tenth.percentage,
    roll_no1: props.qualification_details.tenth.roll_no,
    board_name2: props.qualification_details.twelfth.board_name,
    year2: props.qualification_details.twelfth.year,
    percentage2: props.qualification_details.twelfth.percentage,
    roll_no2: props.qualification_details.twelfth.roll_no,
    board_name3: props.qualification_details.university.board_name,
    year3: props.qualification_details.university.year,
    percentage3: props.qualification_details.university.percentage,
    roll_no3: props.qualification_details.university.roll_no,
    board_name4: props.qualification_details.other.board_name,
    year4: props.qualification_details.other.year,
    percentage4: props.qualification_details.other.percentage,
    roll_no4: props.qualification_details.other.roll_no,
  };
  ...
  <Box sx={{ flexGrow: 1 }} className="p-16 pb-64 sm:p-16 sm:pb-16 md:p-48 md:pb-16">
      <form>
        <Box sx={{ flexGrow: 0 }}>
          <h2 style={{marginBottom:"15px"}}>10th</h2>
        ...
        <Box sx={{ flexGrow: 0 }}>
          <h2 style={{marginBottom:"15px"}}>12th</h2>
          <Grid container spacing={1}>
            <Grid item xs={3}>
              <Controller
                name="board_name2"
        ...
        <Box sx={{ flexGrow: 0 }}>
          <h2 style={{marginBottom:"15px"}}>University Qualification</h2>
          <Grid container spacing={1}>
            <Grid item xs={3}>
              <Controller
                name="board_name3"
        ...
        <Box sx={{ flexGrow: 0 }}>
          <h2 style={{marginBottom:"15px"}}>Other Qualification (Optional)</h2>
          <Grid container spacing={1}>
            <Grid item xs={3}>
              <Controller
                name="board_name4"
...
export default QualificationDetailsTab;
